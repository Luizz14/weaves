...
import { MessageSideContext } from "renderer/components/agents/message-context";
...
export {
	...
	MessageBubbleGroup,
} from "renderer/components/agents/message-bubble";
export type { MessageScrollerProps } from "renderer/components/agents/message-scroller";
export { MessageScroller } from "renderer/components/agents/message-scroller";
		...
		<MessageSideContext.Provider value={from === "user" ? "end" : "start"}>
			<MessageContext.Provider value={{ from }}>
				<motion.article
					...
					data-from={from}
					aria-label={
						props["aria-label"] ?? i18n._(msg({ message: "Message" }))
					}
					initial={
						initial ??
						(animateIn && !reduce
